...
import { prepareTalentProposalMail } from "@/lib/email/talent-proposal";
...
/** 複数マッチの要員提案メールのプレビュー（件名・本文・宛先・送信済み）を一括取得する。送信はしない。 */
export async function POST(req: NextRequest) {
  try {
    ...
    console.error("[POST /api/send-talent/preview-batch]", err);
